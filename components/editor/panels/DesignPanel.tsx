...
import { Sparkles, Edit, Trash2, Plus, Pipette } from 'lucide-react';
...
const DesignPanel: React.FC<DesignPanelProps> = ({
    ...
    return (
        <div className="p-4 space-y-6">
            ...
            <div>
                <h4 className="font-semibold mb-3 text-slate-900 dark:text-slate-100">Color Palette</h4>
                    ...
                    {allPalettes.map(palette => {
                        ...
                        return (
                            <div key={palette.id} className="relative group">
                                ...
                                {/* Show edit/delete buttons for custom palettes on hover */}
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
                <h4 className="font-semibold mb-3 text-slate-900 dark:text-slate-100">Typography</h4>
            ...
            {/* Layout & UI Element Controls */}
            <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
                <h4 className="font-semibold mb-3 text-slate-900 dark:text-slate-100">Layout & Elements</h4>
             ...
             <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
                <h4 className="font-semibold mb-3 text-slate-900 dark:text-slate-100">Animation & Navigation</h4>
                <div className="space-y-6">
                    <div>
            ...
            {/* Custom CSS Section */}
            <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
                <h4 className="font-semibold mb-3 text-slate-900 dark:text-slate-100">Custom CSS (Advanced)</h4>
                 <EditorTextarea 
