...
const getMentorGuide = (
    addBlock: AIMentorPanelProps['addBlock'],
    setActiveBlockId: AIMentorPanelProps['setActiveBlockId'],
    onTriggerProjectCreation: AIMentorPanelProps['onTriggerProjectCreation']
): MentorStage[] => [
    {
 ...
 */
const AIMentorPanel: React.FC<AIMentorPanelProps> = ({ portfolio, onUpdate, setActiveBlockId, addBlock, onTriggerProjectCreation }) => {
